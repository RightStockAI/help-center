...
Comprehensive portfolio tracking, analysis, and optimization tools to manage your investments effectively with AI-powered insights.
...
3. Name your watchlist (e.g., "Growth Stocks", "Dividend Payers")
4. Set criteria or add stocks manually
...
### Managing Stocks in Watchlist

#### Adding Stocks
- Search and add by symbol or company name
- Import from portfolio holdings
- Bulk add via CSV upload
- Copy from other watchlists
...
- **Analyst Ratings** - Upgrade/downgrade alerts
- **Market Events** - Sector-wide news

#### Technical Alerts
- **Breakout Signals** - Resistance/support breaks
- **Pattern Recognition** - Chart pattern alerts
- **Indicator Signals** - RSI, MACD, moving averages
- **Volume Confirmation** - Price movement with volume
